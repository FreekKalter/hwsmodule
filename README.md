...
## Development environment and release process
 ...
 - create virtualenv with Flask and hwsmodule installed into it (latter is installed in
...
install it (`pip install hwsmodule.tar.gz`), ensure that configuration file exists and
`HWSMODULE_SETTINGS` environment variable points to it, ensure that user has access to the
